...
let scienceNews = [];
let healthNews = [];
let intro = ["Hello, I am Zebrun.", " I am an intern at Zebra Technologies", "Hello, My name is Zebrun"];
...
let closing = ['Ok bye-bye', 'As you wish, bye take-care', 'Bye-bye, see you soon in Carivate']
